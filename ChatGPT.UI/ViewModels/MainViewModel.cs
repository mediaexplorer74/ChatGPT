...
public partial class MainViewModel : ObservableObject
{
    ...
    public MainViewModel(Action? exit = null)
    {
        ...
        {
            Prompt = "",
            Message = "Hi! I'm Alice, your Windows Assistant. Would you like to get some assistance?",
            IsSent = false
        };
    ...
    private async Task Send(MessageViewModel sendMessage)
    {
        ...
        var apiKey = "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";
            //"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";
            //"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";
            //"sk-95Ez2Z1rtgegrRTFFDSTVTdsdfsgdv3422kjhLghnh53QiT8F";//Environment.GetEnvironmentVariable("OPENAI_API_KEY");
